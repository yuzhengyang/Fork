...
{
    partial class SimpleShadowBackForm : Form
    {
        #region 属性
        private Point _MouseLocation;
        internal Point MouseLocation { get { return _MouseLocation; } }
        private SimpleShadowForm Main;
        #endregion

        public SimpleShadowBackForm(SimpleShadowForm main)
        {
            InitializeComponent();
            SetStyles();//减少闪烁
            Main = main;//获取控件层对象
        ...
        private void SimpleShadowBackForm_Load(object sender, EventArgs e)
        {
        }
        #region 减少闪烁
